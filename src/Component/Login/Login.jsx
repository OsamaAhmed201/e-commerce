...
export default function Login() {
  let { setToken } = useContext(AuthUserContext)
  ...
  return (
    <>
      <h2 className='text-center  font-extrabold text-green-800 text-lg mt-5'>Login Now</h2>
      ...
      <form onSubmit={loginForm.handleSubmit} className="w-6/12 mx-auto  ">
