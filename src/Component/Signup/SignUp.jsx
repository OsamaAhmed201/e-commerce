        ...
        <div className="flex flex-wrap mx-3">
          <div className="w-7/12 mx-auto">
            <form onSubmit={registerForm.handleSubmit} className="w-full ">
              <div className="mb-5">
                <label htmlFor="name" className="block mb-1 text-sm font-bold text-gray-900 dark:text-white "> Name</label>
                <input
              ...
              <div className="mb-5">
                <label htmlFor="rePassword" className="block mb-1 text-sm font-bold text-gray-900 dark:text-white "> rePassword</label>
                <input
              ...
              <div className="mb-5">
                <label htmlFor="phone" className="block mb-1 text-sm font-bold text-gray-900 dark:text-white "> Phone</label>
                <input
